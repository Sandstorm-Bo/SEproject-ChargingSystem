...
public class ChargingController {
     ...
     */
    @PutMapping("/amount")
    public Result<ChargingRequest> modifyAmount(@RequestParam String carId, @RequestParam Double amount) {
        try {
     ...
     */
    @PutMapping("/mode")
    public Result<ChargingRequest> modifyMode(@RequestParam String carId, @RequestParam String mode) {
        try {
